...
<head>
  ...
  <style type="text/css">
    ...
    */
    ...
    .sudahpunyaakun:hover,
    .sudahpunyaakun:active,
    .sudahpunyaakun:focus{
      color: rgb(12, 97, 33);
    }
...
<body style="font-family: Century Gothic">
  ...
  <div class="container" style="margin-top: -25px;">
        <div class="card card-container">
            ...
            <br>
            <marquee><h5>Create an Account</h5></marquee>
            ...
            <form class="form-signin">
                ...
                <hr>
                <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" value="Sign up"></button>
            </form><!-- /form -->
            <a href="login.php" class="sudahpunyaakun">
                click here if you are already have an account
            </a>
        </div><!-- /card-container -->
    </div><!-- /container -->
</body>
